...
export type TranslationKey =
  ...
  // Chat - External File Attachment
  | 'chat.externalFile.dropHint'
  | 'chat.externalFile.pickerTitle'
  | 'chat.externalFile.pickerError'
  | 'chat.externalFile.fileTooLarge'
  | 'chat.externalFile.attachButton'
  | 'chat.toolbar.effortLabel'
  | 'chat.toolbar.thinkingLabel'
  | 'chat.toolbar.tokenCount'
  | 'chat.toolbar.fastModeToggle'
  | 'chat.externalContext.pickerTitle'
  | 'chat.externalContext.duplicate'
  | 'chat.externalContext.noPath'
  | 'chat.externalContext.pathMustBeAbsolute'
  | 'chat.externalContext.pickerError'
  | 'chat.externalContext.conflictInside'
  | 'chat.externalContext.conflictContains'
  | 'chat.externalContext.title'
  | 'chat.externalContext.empty'
  | 'chat.externalContext.makeSessionOnly'
  | 'chat.externalContext.makePersistent'
  | 'chat.externalContext.removePath'
  | 'chat.externalContext.countTitle'
  | 'chat.externalContext.addTitle'
  | 'chat.mcp.title'
  | 'chat.mcp.noneConfigured'
  | 'chat.mcp.allDisabled'
  | 'chat.mcp.contextSaving'
  | 'chat.mcp.countTitle'
  | 'chat.mcp.enableTitle'
  ...
  | 'settings.sections.basic'
  | 'settings.sections.common'
  | 'settings.advancedSection.title'
  | 'settings.advancedSection.singlePageDesc'
  | 'settings.advancedSection.generalDesc'
  | 'settings.advancedSection.codexDesc'
  | 'settings.permission.confirm'
  | 'settings.permission.auto'
  | 'settings.permission.plan'
  | 'settings.permission.tooltipConfirm'
  | 'settings.permission.tooltipAuto'
  | 'settings.permission.tooltipPlan'
  | 'settings.codex.apiKey.name'
  ...
  | 'settings.codex.safeMode.name'
  | 'settings.codex.safeMode.desc'
  ...
  | 'settings.codex.reasoningSummary.options.auto'
  | 'settings.codex.reasoningSummary.options.concise'
  | 'settings.codex.reasoningSummary.options.detailed'
  | 'settings.codex.reasoningSummary.options.none'
  | 'settings.codex.environment.name'
  | 'settings.codex.environment.desc'
  | 'settings.codex.environment.placeholder'
