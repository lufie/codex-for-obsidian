...
const CODEX_MODELS: ProviderUIOption[] = [
  { value: 'gpt-5.5', label: 'GPT-5.5', description: 'Newest' },
...
export const codexChatUIConfig: ProviderChatUIConfig = {
  ...
  getPermissionModeToggle(): ProviderPermissionModeToggleConfig {
    return {
      ...
      inactiveLabel: t('settings.permission.confirm'),
      activeValue: 'yolo',
      activeLabel: t('settings.permission.auto'),
      planValue: 'plan',
      planLabel: t('settings.permission.plan'),
    };
  },
