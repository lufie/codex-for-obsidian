...
/**
 * Merges ordered external-context path lists while preserving the first occurrence
 * of each normalized path.
 */
export function mergeOrderedExternalContextPaths(...pathGroups: string[][]): string[] {
  const merged: string[] = [];
