...
export class ImageContextManager {
  ...
  private setupDragAndDrop() {
    ...
    dropZone.addEventListener('dragenter', this.handleDragEnter as unknown as EventListener);
    dropZone.addEventListener('dragover', this.handleDragOver as unknown as EventListener);
    dropZone.addEventListener('dragleave', this.handleDragLeave as unknown as EventListener);
    dropZone.addEventListener('drop', this.handleDrop as unknown as EventListener);
  }
  ...
  destroy(): void {
    const dropZone = this.containerEl.querySelector('.claudian-input-wrapper');
    if (dropZone) {
      dropZone.removeEventListener('dragenter', this.handleDragEnter as unknown as EventListener);
      dropZone.removeEventListener('dragover', this.handleDragOver as unknown as EventListener);
      dropZone.removeEventListener('dragleave', this.handleDragLeave as unknown as EventListener);
      dropZone.removeEventListener('drop', this.handleDrop as unknown as EventListener);
    }
    this.inputEl.removeEventListener('paste', this.handlePaste as unknown as EventListener);
