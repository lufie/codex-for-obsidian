...
import type { InlineReferenceComposerManager } from '../ui/InlineReferenceComposerManager';
import type {
  ContextUsageMeter,
...
export interface TabUIComponents {
  ...
  externalFileAttachmentManager: ExternalFileAttachmentManager | null;
  inlineReferenceComposerManager: InlineReferenceComposerManager | null;
...
export interface TabDOMElements {
  ...
  /** Pinned wiki-link chips displayed at the top of the chat view. */
